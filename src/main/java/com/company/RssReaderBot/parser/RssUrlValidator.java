...
public class RssUrlValidator {
    ...
    public RssUrlValidator(int connectionReadTimeout, int connectionConnectTimeout, List<String> requiredContentTypes) {
    ...
    private String validateResponseCode(int responseCode) {
        if (isRedirect(responseCode)) {
            ...
            System.out.println("Redirect to URL: " + url + " - " + responseCode); // debug
            return validateMimeType(connection.getContentType(), url.toString());
        } else {
